exports.jobApplicationTemplate = (context) => {
		...
		<tbody>
			<tr style="vertical-align: top;" valign="top">
				<td style="word-break: break-word; vertical-align: top;" valign="top">
					...
					<div style="background-color:transparent;">
						<div class="block-grid"
							style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #ffd500;">
										...
										<div
											...
											<div align="left" class="img-container left fixedwidth"
												...
												<div style="font-size:1px;line-height:25px"> </div><img alt="Image"
													border="0" class="left fixedwidth" src="https://blytix.com/assets/sets1/images/logo.png"
													style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 210px; display: block;"
													title="Image" width="210" />
											...
											<div
												...
												<div
													...
													<p
														...
														<span style="font-size: 22px;"><strong>Job Application at Blytix</strong></span></p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
											...
											<div
												...
												<div
													style="font-size: 12px; line-height: 1.5; font-family: 'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif; color: #555555; mso-line-height-alt: 18px;">
                                                        ...
                                                        <p
                                                        style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">
                                                        Applicant : ${context.name}
                                                        </p>
                                                        <p
                                                        style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">
                                                        Mobile number: ${context.phone}
                                                        </p>
                                                        <p
                                                        style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">
                                                        E-mail address: ${context.email}
                                                        </p>
                                                        <p
                                                        style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">
					...
					<div
						style="background-image:url('images/bg_password.gif');background-position:top center;background-repeat:no-repeat;background-color:transparent;">
